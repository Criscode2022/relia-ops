  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Relia is a maintenance operations desk for plants and facilities — work orders, preventive maintenance, stores, and downtime in one place.",
      },
